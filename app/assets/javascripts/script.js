$(function() {	
	...
	$('.topnav ul').children('li').each(function() {
		...
		// radius Box
	$('.post-excerpt span').css({"border-radius": "3px", "-moz-border-radius":"3px", "-webkit-border-radius":"3px"});	
	$('.post-commets').css({"border-radius": "3px", "-moz-border-radius":"3px", "-webkit-border-radius":"3px"});	
